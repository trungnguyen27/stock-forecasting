...
class Stocker():
    ...
    def buy_and_hold(self, start_date=None, end_date=None, nshares=1):
        ...
        print('{} Total buy and hold profit from {} to {} for {} shares = VNĐ{:.2f}'.format
    ...
    def create_prophet_model(self, days=0, resample=False):
        ...
        if days > 0:
            ...
            print('Predicted Price on {} = VNĐ{:.2f}'.format(
